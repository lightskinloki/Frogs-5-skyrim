...
plain("**ESBERN** (climbing out, stiff, blinking at the open sky): \"Well. Kept below decks until we were clear of the gates. Sound tradecraft, that.\" (working a kink out of his back, squinting at the light) \"The Thalmor have a standing warrant on me, and Riften's crawling with their eyes -- out here I'm just an old man on a cart, which suits me fine. Now -- where are we headed, and what fresh end of the world am I to help you with?\"")
bullet("**If they own up to forgetting him:** he laughs -- a real one. \"Two whole days. Not one knock on the floorboards.\" He's genuinely delighted, not stinging them for it. \"I've spent worse stretches in worse company. Don't fret it.\"")

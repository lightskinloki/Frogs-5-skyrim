...
readaloud([
    "His hand moves to the other half of the board, and his voice drops, goes more careful. 'This one isn't the dragons. Say that back to me, because it's the mistake that gets people killed out here.' He taps the Eldergleam, the Steps, the Throat, each one circled twice in charcoal. 'Something is unmaking the world instead of ending it. Different hunger. Different hand behind it. Go looking for one enemy tying these two together and you'll be looking a long time. There isn't one. There's two, and neither knows the other exists.'",
])

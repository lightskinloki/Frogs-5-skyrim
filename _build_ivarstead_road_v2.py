...
gm("Klimmek's been at the Bee and Barb three days now, telling the room what he saw on the 7,000 Steps (Ch.20-22) -- Bjorn's the one who actually sat with him past the first telling, morning after morning. He's come to see the cart off.")
readaloud([
...
plain("**ESBERN** (climbing out slow, blinking at the sky like he'd forgotten it existed): \"Above deck.\" A long breath. \"I'd nearly forgotten what that felt like.\" He looks out at the road, the gold hills. \"Riverwood road, this time of year. Good traveling weather. We're finally going for that stone.\"")
bullet("**If they own up to forgetting him:** he doesn't laugh. \"Two days. Anyone could have been under that floor instead of me. A Thalmor plant. A corpse.\" He straightens, meets their eyes. \"I have survived thirty years by checking. Every door. Every floor. If none of you are checking, I am riding into a dragon war with people who will get me killed.\" A beat. \"So. Who's checking the cart from now on?\"")
...
readaloud([
    "He taps the first pin, then walks two fingers down the row, naming each one like he's counting coins. 'Five of them. Dragon priests, asleep under five mountains, until they weren't.' He stops on the loose one, hanging off its tomb by a thread. 'This one woke on his own and walked out. You saw the tomb -- empty, no mark on it, like he just stood up and left.' A beat. 'The other four, I don't know yet.' He looks at the blank spaces on the map where their tombs should be. 'That's what the Dragonstone would tell me. Without it, I'm guessing at graves.'",
])
bullet("Five sleeping priests, each pinned to a tomb: **NAHKRIIN -- VOKUN -- RAHGOT -- OTAR -- MOROKEI.** Rahgot's pin has been moved OFF its tomb and left dangling (the party's own report from Forelhost: he rose and walked out). Esbern keeps touching it like it's sore.")
...
bullet("The Eldergleam, corrupted. The 7,000 Steps, bleeding. The Throat of the World, circled twice in charcoal. Darkwater Crossing, consumed -- the same refugees they passed on the road weeks back came from there. NOT ONE thread crosses from grey to red -- and if a player ties them together, Esbern physically stops their hand: \"No. Two ends of the world, two different authors. Muddle them and you'll parry the wrong one.\"")
label("WHAT HE SAYS AT THE PINS (in pieces, reacting to what THEY know)")
bullet("**On the two apocalypses:** \"Alduin. The World-Eater, they used to call him. He ends this age. The next one starts after. A war has a will behind it -- something you can face, fight, kill if you're strong enough.\" A beat. \"The other thing, I can't call a war. I don't know what it wants. I only know the land stays dead after.\"")
bullet("**IF THEY MENTION THE MIDDEN'S CRYSTALLIZED CULTIST:** He goes still. \"Mythic Dawn.\" \"Two hundred years old. They tried to tear open Oblivion in Dagon's name.\" He looks at the four circles on the grey thread. \"I thought that order was dead. Daedra-worshippers -- Dagon's, specifically. Convinced the Divines are jailers and he's the one who'd break the cage. They murdered Emperor Uriel Septim and his three sons -- with no heir to light the Dragonfires, the ward died, and Oblivion poured straight through the gap. Took another Emperor, Martin Septim, becoming a god to close it.\"")
...
readaloud([
    "Ahkari settles onto an overturned crate, and the change is immediate -- her voice drops into something older, pitched to carry past the first ring of firelight into the second. She's told this one enough times the words don't need finding anymore.",
    "'North of here, before this road saw two travelers a season, there was a grove gone wrong. The trees black at the root, and something living in the heart of it wearing bark for armor and bone for a crown. It had taken three woodcutters and a priestess of Kynareth, and it was not finished eating.",
    "Five strangers went in after them. Four came out walking.",
    "The orc among them cut two of the captives free with his own hands while the thing came for him. He freed the third too -- the priestess -- and by then it was on him. They say he stood between it and her when the killing blow came, and that he had time to move, and didn't.",
    "The small one finished what the orc's dying bought him. A Khajiit, they say, quick as spilled water, who split that thing down the middle with nothing but his own two hands and walked out of the grove wearing its blood like a second coat. And there was a fifth -- a wizard, lost in the maze of roots until the sound of the fight found him, who came out of the dark throwing fire at the last of it.",
    "The priestess lived. Ahkari has heard she tends a temple somewhere south of here still, still Kynareth's, still breathing.'",
    "She feeds a stick into the fire and doesn't say anything for a moment.",
    "'Loggers still won't cut near that grove without leaving something at the treeline first, and nobody living taught them why. Nobody in this one's family was there to see it happen. But that offering's older than anyone can say who started it, and it hasn't stopped. That's how this one knows it's true.'",
])
gm("She has no idea who's sitting across her fire. Let the table feel that, and decide for themselves whether to say anything. [Sourced to Ch.1-2 -- the Battle for the Heart-Tree of Thornheart Grove, the party's founding deed: Azura the orc freed all three captives (two woodcutters, then Danica) and died shielding her from the Heart-Keeper's killing blow; Kyboah delivered the finishing strike bare-handed; Alfonso, lost in the grove's maze, arrived mid-fight and turned it with Fireball -- his first appearance in the campaign. DAVINIA AND SAIJAH WERE BOTH THERE (Ismara holds the memory even if she doesn't feel it the way Davinia would). Orion was not part of this one. Old enough now to have calcified into local legend, distorted by retelling the way real stories are -- and it is actually about the Lanterns, which is the point: this is how the wider world currently remembers them, not an unrelated legend swapped in for safety.]")
...
plain("Esbern breaks the quiet first, once it's safe to talk.")
plain("**ESBERN**: \"We didn't see them coming. Again.\" He taps the side of the cart, hard. \"The Dragonstone doesn't just mark the priests. It shows every dragon grave in Skyrim.\" A beat. \"We need that stone. Badly.\"")
...
bullet("**GAELEN DOES NOT FIGHT THIS ENCOUNTER.** He spends the whole scene trying to bring them over, not defending himself -- Jasper is the one who fights, and the anchors are the only obstacle. If a player attacks him directly, he does not retaliate. He keeps talking.")
...
bullet("**IF A PLAYER NAMES MYTHIC DAWN / CAMORAN TO HIM:** His hands keep working the shards while he answers, unhurried. \"Mythic Dawn. Yes.\" A beat. \"Does the name trouble you more than anything I've actually said?\"")

...
which is the AUTHORITATIVE memory system for this project. Do NOT rely on Codex's
...
These rules exist so that a new session, or switching models within Codex, can NEVER
